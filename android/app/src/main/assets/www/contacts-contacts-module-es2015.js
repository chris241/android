...
/* harmony import */ var _trixprod_api_verse_real_estate_api_contact_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @trixprod/api-verse-real-estate/api/contact.service */ "./node_modules/@trixprod/api-verse-real-estate/api/contact.service.ts");
...
let ContactsPage = class ContactsPage {
    constructor(route, alertClientService, contactService) {
        this.route = route;
