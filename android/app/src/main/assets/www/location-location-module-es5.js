...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["location-location-module"], {
  ...
  function srcAppPagesLocationLocationPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LocationPage = /*#__PURE__*/function () {
      function LocationPage(route, activatedRoute, alertClientService, contractClientService) {
      ...
      _createClass(LocationPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.contractClientService.getContract(this.id).subscribe(function (list) {
            _this.contratOut = list;
            _this.contrat = _this.contratOut.contract;
            _this.contact = _this.contratOut.contract.tenant;
            _this.alerts = _this.contratOut.alerts;
            _this.nbr = _this.alerts.length;
            console.log(_this.contratOut);
            console.log(_this.contrat);
            console.log(_this.nbr);
          });
        }
      }, {
        key: "retour",
