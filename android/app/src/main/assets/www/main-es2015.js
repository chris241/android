...
const routes = [
    ...
    {
        path: 'appartements',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-appartements-appartements-module */ "appartements-appartements-module").then(__webpack_require__.bind(null, /*! ./pages/appartements/appartements.module */ "./src/app/pages/appartements/appartements.module.ts")).then(m => m.AppartementsPageModule)
    },
    {
        path: 'alertes',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-alertes-alertes-module */ "alertes-alertes-module").then(__webpack_require__.bind(null, /*! ./pages/alertes/alertes.module */ "./src/app/pages/alertes/alertes.module.ts")).then(m => m.AlertesPageModule)
    },
    {
        path: 'appartement',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-appartement-appartement-module */ "appartement-appartement-module").then(__webpack_require__.bind(null, /*! ./pages/appartement/appartement.module */ "./src/app/pages/appartement/appartement.module.ts")).then(m => m.AppartementPageModule)
    },
    {
        path: 'operations',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-operations-operations-module */ "operations-operations-module").then(__webpack_require__.bind(null, /*! ./pages/operations/operations.module */ "./src/app/pages/operations/operations.module.ts")).then(m => m.OperationsPageModule)
    },
    {
        path: 'contacts',
    ...
    {
        path: 'settings',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-settings-settings-module */ "settings-settings-module").then(__webpack_require__.bind(null, /*! ./pages/settings/settings.module */ "./src/app/pages/settings/settings.module.ts")).then(m => m.SettingsPageModule)
    },
    {
        path: 'location',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-location-location-module */ "location-location-module").then(__webpack_require__.bind(null, /*! ./pages/location/location.module */ "./src/app/pages/location/location.module.ts")).then(m => m.LocationPageModule)
    }
];
...
/* harmony import */ var _interceptors_auth_expired_interceptor__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./interceptors/auth-expired.interceptor */ "./src/app/interceptors/auth-expired.interceptor.ts");
...
/* harmony import */ var _interceptors_api_interceptor__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./interceptors/api.interceptor */ "./src/app/interceptors/api.interceptor.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        imports: [
            ...
            ngx_webstorage__WEBPACK_IMPORTED_MODULE_10__["NgxWebstorageModule"].forRoot({ prefix: 'jhi', separator: '-' }),
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _trixprod_api_verse_real_estate__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @trixprod/api-verse-real-estate */ "./node_modules/@trixprod/api-verse-real-estate/index.ts");
/* harmony import */ var _services_auth_api_auth_api_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/auth/api/auth-api.service */ "./src/app/services/auth/api/auth-api.service.ts");
...
/* harmony import */ var src_assets_appPreferenceKeys__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/assets/appPreferenceKeys */ "./src/assets/appPreferenceKeys.ts");
...
let ApiInterceptor = class ApiInterceptor {
    ...
    intercept(req, next) {
        ...
        if (_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].production) {
            url = url.replace(this.oldApiServicesUrl, _environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiServicesUrl).
                replace(this.oldApiAuthUrl, _environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiAuthUrl);
        }
        else {
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(ngx_webstorage__WEBPACK_IMPORTED_MODULE_4__["LocalStorage"])(src_assets_appPreferenceKeys__WEBPACK_IMPORTED_MODULE_5__["keys"].apiServicesUrl),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", String)
], ApiInterceptor.prototype, "apiServicesUrl", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(ngx_webstorage__WEBPACK_IMPORTED_MODULE_4__["LocalStorage"])(src_assets_appPreferenceKeys__WEBPACK_IMPORTED_MODULE_5__["keys"].apiAuthUrl),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", String)
], ApiInterceptor.prototype, "apiAuthUrl", void 0);
ApiInterceptor = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_trixprod_api_verse_real_estate__WEBPACK_IMPORTED_MODULE_2__["AlertClientService"]])
], ApiInterceptor);
...
let AuthExpiredInterceptor = class AuthExpiredInterceptor {
    ...
    intercept(request, next) {
        return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((event) => { }, (err) => {
...
AuthExpiredInterceptor = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])(),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_login_login_service__WEBPACK_IMPORTED_MODULE_4__["LoginService"]])
...
let AuthInterceptor = class AuthInterceptor {
    ...
    intercept(request, next) {
        if (!request ||
            !request.url ||
            (/^http/.test(request.url) && !request.url.startsWith(_services_auth_api_auth_api_service__WEBPACK_IMPORTED_MODULE_3__["AuthApiService"].API_URL) && !request.url.startsWith(this.servicesEndpoint))) {
...
AuthInterceptor = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [ngx_webstorage__WEBPACK_IMPORTED_MODULE_2__["LocalStorageService"], ngx_webstorage__WEBPACK_IMPORTED_MODULE_2__["SessionStorageService"]])
], AuthInterceptor);
...
/* harmony import */ var _api_auth_api_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./api/auth-api.service */ "./src/app/services/auth/api/auth-api.service.ts");
...
let AccountService = class AccountService {
    ...
    fetch() {
        return this.http.get(_api_auth_api_service__WEBPACK_IMPORTED_MODULE_5__["AuthApiService"].API_URL + '/account', { observe: 'response' });
    }
    save(account) {
        return this.http.post(_api_auth_api_service__WEBPACK_IMPORTED_MODULE_5__["AuthApiService"].API_URL + '/account', account, { observe: 'response' });
    }
...
AccountService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [ngx_webstorage__WEBPACK_IMPORTED_MODULE_3__["SessionStorageService"], _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]])
], AccountService);
...
AuthApiService = AuthApiService_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
        providedIn: 'root'
    }),
...
/* harmony import */ var _api_auth_api_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./api/auth-api.service */ "./src/app/services/auth/api/auth-api.service.ts");
...
let AuthServerProvider = class AuthServerProvider {
    ...
    login(credentials) {
        ...
        return this.http.post(_api_auth_api_service__WEBPACK_IMPORTED_MODULE_6__["AuthApiService"].API_URL + '/authenticate', data, { observe: 'response' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(authenticateSuccess.bind(this)));
...
AuthServerProvider = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], ngx_webstorage__WEBPACK_IMPORTED_MODULE_3__["LocalStorageService"], ngx_webstorage__WEBPACK_IMPORTED_MODULE_3__["SessionStorageService"]])
], AuthServerProvider);
...
/* harmony import */ var _auth_account_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../auth/account.service */ "./src/app/services/auth/account.service.ts");
/* harmony import */ var _auth_auth_jwt_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../auth/auth-jwt.service */ "./src/app/services/auth/auth-jwt.service.ts");
...
LoginService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_auth_account_service__WEBPACK_IMPORTED_MODULE_3__["AccountService"],
        _auth_auth_jwt_service__WEBPACK_IMPORTED_MODULE_4__["AuthServerProvider"],
...
module.exports = __webpack_require__(/*! C:\Users\Chris\Music\Verse-master\src\main.ts */"./src/main.ts");
