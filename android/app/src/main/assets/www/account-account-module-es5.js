...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["account-account-module"], {
  ...
  function srcAppPagesAccountAccountModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _account_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./account.page */
    ...
    AccountPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
  ...
  function srcAppPagesAccountAccountPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _trixprod_api_verse_real_estate_api_rentalClient_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    var AccountPage = /*#__PURE__*/function () {
      function AccountPage(alertClientService, rentalClientService, sanitizer) {
      ...
      _createClass(AccountPage, [{
        ...
        value: function essai() {
          ...
          this.rentalClientService.getRentalsList().subscribe(function (list) {
            _this.rentals = list.rentals; // const reader = new FileReader();
        ...
        value: function ngOnInit() {
          ...
          this.essai(); //console.log("hehe "+this.alertes.length);
        }
      }]);
